...
native libraries that have no User Interface (UI) for the user
* Examples would be persistent storage, notifications, network events
* These are accessible to your user as JavaScript functions and objects.
